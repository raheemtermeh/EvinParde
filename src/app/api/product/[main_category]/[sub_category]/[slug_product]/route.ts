// app/api/product/[main_category]/[sub_category]/[slug_product]/route.ts
...
export async function GET(
  ...
  try {
    ...
    console.log('Fetching:', { main_category, sub_category, slug_product });

    const apiUrl = `http://curtain.linooxel.com:5042/api/product/${main_category}/${sub_category}/${slug_product}/`;
    ...
    console.log('API Response Status:', res.status); // دیباگ
