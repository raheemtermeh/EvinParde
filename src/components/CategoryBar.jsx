...
const categories = [
  ...
  {
    name: "پرده ورتیکال",
    slug: "vertical-curtain",
    image: "https://picsum.photos/id/1015/400/500",
  },
  {
    name: "پرده دومکانیزم",
    slug: "duplex-curtain",
    image: "https://picsum.photos/id/1020/400/500",
  },
  {
    name: "پرده زبرا چاپی",
    slug: "printed-zebra",
  ...
  },
  {
    name: "پرده پذیرایی",
    slug: "living-room",
    image: "https://picsum.photos/id/1030/400/500",
  },
];
    ...
    <div className="mt-8 relative z-20 container mx-auto px-4 sm:px-6 lg:px-8">
      <div className="flex flex-row-reverse overflow-x-auto space-x-3 sm:space-x-4 space-x-reverse pb-6 scrollbar-hide">
        {data?.items.length > 0 &&  data?.items.map((category) => (
           <Link key={category.slug} href={`/product/pardeh/${category.slug}/`} className="hover:text-[#246e72]">
          ...
          >
            <div className="relative w-full h-full">
              ...
              <div className="absolute bottom-0 w-full bg-[#246e72] bg-opacity-90 text-white text-center py-2 sm:py-3 z-10">
